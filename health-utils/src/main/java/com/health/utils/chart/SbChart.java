 ...
 * @author timmolter
 */
public class SbChart extends Chart<XYStyler, XYSeries> {
   ...
   * @param height
   */
  public SbChart(int width, int height) {
   ...
   */
  public SbChart(int width, int height, Theme theme) {
   ...
   */
  public SbChart(int width, int height, ChartTheme chartTheme) {
   ...
   * @param chartBuilder
   */
  public SbChart(SbChartBuilder chartBuilder) {
