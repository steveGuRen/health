/*************************
 * 1. AngularJS v1.4.3
 * 2. State-based routing for AngularJS   @version v0.2.15
 * 3. angular-ui-bootstrap ui.bootstrap.tpls  Version: 0.13.4 - 2015-09-03**delete**
 * 4. angular-ui-bootstrap ui.bootstrap.collapse  Version: 0.13.3 - 2015-08-09**delete**
 * 5. ui-cookie AngularJS v1.4.3
 * ****已删****7. ng-file-upload-shim.min.js  7.2.1
 * 6. ng-file-upload.min.js  7.2.1 
 * 8. angular-services Version: 1.0.0 - 2015-09-03 License: IND
 * 9. jQuery v2.1.4 | (c) 2005, 2015 jQuery Foundation, Inc. | jquery.org/license
 * 
 * 
 * 前台框架，以angular、jquery为核心
...
(function(O, U, t) {
    ...
    function ka(b, a) {
        ...
        if (c == typeof a && "object" == c)
            if (G(b)) {
                ...
                if (Za(b))
                    return Za(a) ? b.toString() == a.toString() : !1;
            ...
            m(a, function(a) {
                ...
                if (!n.get(a)) {
                    ...
                    try {
                        ...
                        d(c._invokeQueue),
                        d(c._configBlocks)) : z(a) ? b.push(s.invoke(a)) : G(a) ? 
                        b.push(s.invoke(a)) : Qa(a, "module")
                    } catch (e) {
                        throw G(a) && (a = a[a.length - 1]),
    ...
    function Ec(b, a) {
            ...
            b.factory(a + "Directive", ["$injector", "$exceptionHandler", function(b, d) {
                ...
                m(e[a], function(e, g) {
                    try {
                        ...
                        H(l.scope) && (!0 === l.bindToController ? (n.bindToController = c(l.scope, s, !0),
                        n.isolateScope = {}) : n.isolateScope = c(l.scope, s, !1));
        ...
        this.aHrefSanitizationWhitelist = function(b) {
            return w(b) ? (a.aHrefSanitizationWhitelist(b),
            this) : a.aHrefSanitizationWhitelist()
        }
        ;
        this.imgSrcSanitizationWhitelist = function(b) {
            return w(b) ? (a.imgSrcSanitizationWhitelist(b),
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, d, u, p, K, q, I, B, N) {
            ...
            function va(a, b, c) {
                ...
                if (b && a.hasAttribute && a.hasAttribute(b)) {
                    do {
                        ...
                        a.nodeType == qa && (a.hasAttribute(b) && e++,
                        a.hasAttribute(c) && e--);
                        d.push(a);
                        a = a.nextSibling
                    } while (0 < e)
            ...
            function E(a, b, d, e, f, g, h, k, s) {
                ...
                function S(a, c, e, f, g, l) {
                    ...
                    if (m) {
                        var K = u || $, I;
                        K && m[K.name] && (p = K.$$bindings.bindToController,
                        (C = m[K.name]) && C.identifier && p && (I = C,
                        l.$$destroyBindings = W(c, f, C.instance, p, K)));
                        for (n in m) {
                            C = m[n];
                            var E = C();
                            E !== C.instance && (C.instance = E,
                            ja.data("$" + n + "Controller", E),
                            C === I && (l.$$destroyBindings(),
                    ...
                    for (l = h.length; n < l; n++)
                        p = h[n],
                        Y(p, p.isolateScope ? F : c, ja, f, p.require && B(p.directiveName, p.require, ja, m), ha);
                    var va = c;
                ...
                for (var F = -Number.MAX_VALUE, $ = s.newScopeDirective, N = s.controllerDirectives, u = s.newIsolateScopeDirective, D = s.templateDirective, m = s.nonTlbTranscludeDirective, K = !1, I = !1, q = s.hasElementTranscludeDirective, ba = d.$$element = y(b), E, w, v, A = e, Aa, xa = 0, Ta = a.length; xa < Ta; xa++) {
                    ...
                    if (v = E.scope)
                        E.templateUrl || 
                        (H(v) ? (O("new/isolated scope", u || $, E, ba),
                        u = E) : O("new/isolated scope", u, E, ba)),
                        $ = $ || E;
                    w = E.name;
                    !E.templateUrl && E.controller && (v = E.controller,
                    N = N || ga(),
                    O("'" + w + "' controller", N[w], E, ba),
                    N[w] = E);
                    if (v = E.transclude)
                        K = !0,
                        E.$$tlb || (O("transclusion", m, E, ba),
                        m = E),
                        "element" == v ? (q = !0,
                        F = E.priority,
                        v = ba,
                        ba = d.$$element = y(U.createComment(" " + w + ": " + d[w] + " ")),
                        b = ba[0],
                        T(f, za.call(v, 0), b),
                        A = Z(v, e, F, g && g.name, {
                    ...
                    E.terminal && (S.terminal = !0,
                    F = Math.max(F, E.priority))
                }
                S.scope = $ && !0 === $.scope;
            ...
            function w(b, d, f, g, h, k, l) {
                ...
                if (e.hasOwnProperty(d)) {
                    ...
                    for (var p = 0, B = d.length; p < B; p++)
                        try {
                            n = d[p],
                            (g === t || g > n.priority) && -1 != n.restrict.indexOf(f) && (k && (n = Ob(n, {
                                $$start: k,
                                $$end: l
                            })),
                            b.push(n),
            ...
            function Lf(a, b, c, e, f, g, h, k) {
                ...
                return function(a, b, c, d, e) {
                    a = e;
                    b.$$destroyed || (l ? l.push(b, c, d, a) : (s.transcludeOnThisElement && (a = $(b, s.transclude, e)),
                    s(n, b, c, d, a, s)))
                }
            }
            function Aa(a, b) {
            ...
            function T(a, b, c) {
                ...
                a.appendChild(d);
                y.hasData(d) && (y(c).data(y(d).data()),
                la ? (Rb = !0,
                la.cleanData([d])) : delete y.cache[d[y.expando]]);
                d = 1;
                for (e = b.length; d < e; d++)
                    f = b[d],
                    y(f).remove(),
    ...
    function Xe() {
        ...
        this.$get = ["$injector", "$window", function(c, d) {
            ...
            return function(f, g, h, l) {
                ...
                if (h)
                    return h = (G(f) ? f[f.length - 1] : f).prototype,
    ...
    function bf() {
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(d, e, f, g, h, l) {
            ...
            function n(c, f) {
                ...
                N && (D = N.get(S),
                w(D) ? D && z(D.then) ? D.then(x, x) : G(D) ? n(D[1], D[0], ia(D[2]), D[3]) : n(D, 200, {}, "OK") : N.put(S, B));
    ...
    function dc(b, a) {
        ...
        this.$$parseLinkUrl = function(d, e) {
            ...
            var f, g;
            (f = ya(b, d)) !== t ? (g = f,
            g = (f = ya(a, f)) !== t ? c + (ya("/", f) || f) : b + g) : (f = ya(c, d)) !== t ? g = c + f : c == d + "/" && (g = c);
            g && this.$$parse(g);
            return !!g
        }
    }
    ...
    function ff() {
        ...
        this.html5Mode = function(b) {
            ...
            this) : H(b) ? (ab(b.enabled) && (a.enabled = b.enabled),
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function(c, d, e, f, g) {
            ...
            f.on("click", function(b) {
                if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && !b.shiftKey && 2 != b.which && 2 != b.button) {
                    ...
                    x.test(h) || 
                    !h || e.attr("target") || b.isDefaultPrevented() || !k.$$parseLinkUrl(h, l) || (b.preventDefault(),
    ...
    function hf() {
        ...
        this.$get = ["$filter", "$sniffer", function(c, d) {
            ...
            function k(a, b) {
                ...
                f ? c.$$watchDelegate = a.$$watchDelegate : b.$stateful || (c.$$watchDelegate = f,
            ...
            return function(d, e, C) {
                ...
                case "string":
                    ...
                    m.constant ? m.$$watchDelegate = l : u ? m.$$watchDelegate = m.literal ? h : g : m.inputs && (m.$$watchDelegate = f),
                    q[p] = m);
                    return k(m, 
                    e);
                case "function":
    ...
    function td(b, a) {
        ...
        function f(c) {
            !c.processScheduled && 
            c.pending && (c.processScheduled = !0,
            b(function() {
                var b, d, e;
                e = c.pending;
                        ...
                        a: do {
                            if (k = x.$$watchers)
                                for (n = k.length; n--; )
                                    try {
                                        if (b = k[n])
                                            if ((f = b.get(x)) !== (h = b.last) && !(b.eq ? ka(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h)))
                                                s = !0,
                                                d = b,
    ...
    var Pa = Q.prototype = {
        ready: function(b) {
            ...
            var c = !1;
            "complete" === U.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a),
            Q(O).on("load", a))
        },
        toString: function() {
            var b = [];
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length; ) {
                ...
                if (f)
                    ...
                    this.index += 4,
                    d += String.fromCharCode(parseInt(f, 16))) : d += qg[g] || g,
                    f = !1;
                else if ("\\" === g)
                    f = !0;
                else {
    ...
    q.prototype = {
        ...
        primary: function() {
            ...
            this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.constants.hasOwnProperty(this.peek().text) ? a = fa(this.constants[this.consume().text]) : this.peek().identifier ? a = this.identifier() : this.peek().constant ? a = this.constant() : 
                ...
                case q.CallExpression:
                    ...
                    k.recurse(a.callee, l, h, function() {
                        k.if_(k.notNull(l), function() {
                            ...
                            r = k.member(h.context, h.name, h.computed) + "(" + n.join(",") + ")") : r = l + "(" + n.join(",") + ")";
                            r = k.ensureSafeObject(r);
                            k.assign(c, r)
                        }
                        , function() {
    ...
    sd.prototype = {
        ...
        recurse: function(a, c, d) {
            ...
            case q.Identifier:
                return Ca(a.name, g.expression),
                g.identifier(a.name, g.expensiveChecks || Fb(a.name), 
                c, d, g.expression);
            case q.MemberExpression:
                return e = this.recurse(a.object, !1, !!d),
                a.computed || (Ca(a.property.name, g.expression),
                f = a.property.name),
            ...
            return {
                ...
                link: function(d, e, f) {
                    ...
                    f.$observe(c, function(c) {
                        c ? (f.$set(h, c),
                        Ua && g && e.prop(g, f[h])) : "href" === a && f.$set(h, null )
                    }
                    )
                }
            }
                ...
                compile: function(d, e) {
                    ...
                    return {
                        pre: function(a, d, e, k) {
                            ...
                            var m = k.$$parentForm;
                            f && (Eb(a, k.$name, k, k.$name),
                            e.$observe(f, function(c) {
                                k.$name !== c && (Eb(a, k.$name, t, k.$name),
                                m.$$renameControl(k, c),
            ...
            compile: function(e, f) {
                ...
                return function(e, f, m, s, q) {
                    ...
                    e.$watch(g, function(g) {
                        ...
                        e.$emit("$includeContentRequested", g)) : (v(),
                        s.template = null )
                    }
                    )
                }
      ...
      , Qe = ["$compile", function(a) {
        return {
            ...
            link: function(c, d, e, f) {
                ...
                a(Nc(f.template, U).childNodes)(c, function(a) {
                    d.append(a)
                }
                , 
                {
      ...
      , wg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, c, d, e, f, g, h, l, k, n) {
        ...
        this.$$setOptions = function(a) {
            if ((p.$options = a) && a.getterSetter) {
                ...
                throw Lb("nonassign", d.ngModel, ua(e));
        }
        ;
        this.$render = v;
        ...
        function(a, c, d) {
            ...
            (function() {
                ...
                if (u === t)
                    ...
                    return u || (m(p.$validators, function(a, c) {
                        g(c, null )
                    }
                    ),
    ...
    Je = ["$compile", "$parse", function(a, c) {
        ...
        return {
            ...
            link: function(c, h, l, k) {
                ...
                function r(a, c, d, e) {
                    c && M(c.nodeName) === d ? d = c : (d = e.cloneNode(!1),
                ...
                function t() {
                    ...
                    if (!v.$isEmpty(a)) {
                        var g = u.readValue();
                        (z.trackBy ? ka(a, g) : a === g) || (v.$setViewValue(g),
                        v.$render())
                    }
                }
                var v = k[1];
                if (v) {
                    ...
                    function() {
                        ...
                        c && !c.disabled ? h[0].value !== c.selectValue && (N.remove(),
                        B || p.remove(),
                        h[0].value = c.selectValue,
                        c.element.selected = !0,
                        c.element.setAttribute("selected", "selected")) : null  === a || B ? (N.remove(),
                        B || h.prepend(p),
                        h.val(""),
                        p.prop("selected", !0),
                        p.attr("selected", !0)) : (B || p.remove(),
                        h.prepend(N),
                        h.val("?"),
                        N.prop("selected", !0),
                        N.attr("selected", !0))
                    ...
                    B ? (p.remove(),
                    a(p)(c),
                    p.removeClass("ng-scope")) : p = y(e.cloneNode(!1));
                    t();
        ...
        return {
            link: function(g, h, l) {
                ...
                g.$watch(n, function(c) {
                    ...
                    e === z || f && V(z) && isNaN(z) || (y(),
                    f = t[e],
                    A(f) ? (null  != c && d.debug("ngPluralize: no rule defined for '" + e + "' in " + r),
                    y = v,
                    k()) : y = g.$watch(f, k),
                    z = e)
                }
                    ...
                    a.$watchCollection(r, function(g) {
                        ...
                        for (k = 0; k < I; k++)
                            ...
                            J.scope) {
                                ...
                                do
                                    x = x.nextSibling;
                                while (x && x.$$NG_REMOVED);J.clone[0] != x && c.move(qb(J.clone), null , y(u));
    ...
    function(a) {
      ...
      , Ke = Ma({
        ...
        link: function(a, c, d, e, f) {
            if (!f)
                throw J("ngTransclude")("orphan", ua(c));
            f(function(a) {
                c.empty();
                c.append(a)
            }
            ...
            link: function(a, c, d, e) {
                if (e) {
                    ...
                    d.$observe("pattern", function(a) {
                        ...
                        if (a && !a.test)
                            throw J("ngPattern")("noregexp", g, a, ua(c));
                        f = a || t;
                        e.$validate()
                    }
                    );
...
ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function(a, b, c) {
        ...
        return d.headers.__setXHR_ = function() {
            return function(a) {
                ...
                a.upload.addEventListener("progress", function(a) {
                    a.config = d,
                    e.notify ? e.notify(a) : f.progressFunc && c(function() {
                        f.progressFunc(a)
                    }
                    )
                }
    ...
    this.upload = function(a) {
            ...
            if (void 0 !== d)
                ...
                angular.isString(d))
                    ...
                    if (angular.isObject(d))
                        for (var f in d)
                            d.hasOwnProperty(f) && b(c, d[f], e + "[" + f + "]");
                    else
                        c.append(e, d);
                else
                    d = angular.isString(d) ? d : angular.toJson(d),
                    "json-blob" === a.sendFieldsAs ? c.append(e, new Blob([d],{
                        type: "application/json"
                    })) : c.append(e, d)
        }
        function c(a) {
            return a instanceof Blob || a.flashId && a.name && a.size
        }
        function e(a, b, d) {
            if (c(b))
                a.append(d, b, b.fileName || b.name);
            else {
                if (!angular.isObject(b))
                    throw "Expected file object in Upload.upload file option: " + b.toString();
                for (var f in b)
                    if (b.hasOwnProperty(f)) {
                        var g = f.split(",");
                        g[1] && (b[f].fileName = g[1].replace(/^\s+|\s+$/g, "")),
                        e(a, b[f], g[0])
                    }
            }
        }
        ...
        a.transformRequest.push(function(c) {
            var d, f = new FormData, g = {};
            for (d in a.fields)
                a.fields.hasOwnProperty(d) && (g[d] = a.fields[d]);
            c && (g.data = c);
            for (d in g)
                if (g.hasOwnProperty(d)) {
                    var h = g[d];
                    a.formDataAppender ? a.formDataAppender(f, d, h) : b(f, h, d)
                }
            if (null  != a.file)
                if (angular.isArray(a.file))
                    for (var i = 0; i < a.file.length; i++)
                        e(f, a.file[i], "file");
                else
                    e(f, a.file, "file");
            return f
...
ngFileUpload.service("Upload", ["$parse", "$timeout", "$compile", "UploadResize", function(a, b, c, d) {
    var e = d;
    ...
    e.attrGetter = function(b, c, d, e) {
        if (!d)
            return this.getAttrWithDefaults(c, b);
        try {
    ...
    e.updateModel = function(c, d, f, g, h, i, j) {
        function k() {
            ...
            if (c) {
                var k = !e.attrGetter("ngfMultiple", d, f) && !e.attrGetter("multiple", d) && !m;
                a(e.attrGetter("ngModel", d)).assign(f, k ? j : h)
            }
            var l = e.attrGetter("ngfModel", d);
            l && a(l).assign(f, h),
            g && a(g)(f, {
                $files: h,
                $file: j,
        ...
        function l(a, b) {
            var c = e.attrGetter("ngfResize", d, f);
            if (!c)
                return b();
            ...
            , j = function(a) {
                return function(b) {
                    h(),
                    a.$error = "resize",
                    a.$errorParam = (b ? (b.message ? b.message : b) + ": " : "") + (a && a.name)
                }
            }
            , k = 0; k < a.length; k++) {
                var l = a[k];
                l.$error || 0 !== l.type.indexOf("image") ? h() : e.resize(l, c.width, c.height, c.quality).then(i(k), j(l))
            }
        }
        var m = e.attrGetter("ngfKeep", d, f);
        if (m === !0) {
            if (!h || !h.length)
                return;
            var n = (c && c.$modelValue || d.$$ngfPrevFiles || []).slice(0)
              , o = !1;
            if (e.attrGetter("ngfKeepDistinct", d, f) === !0) {
                for (var p = n.length, q = 0; q < h.length; q++) {
                    for (var r = 0; p > r && h[q].name !== n[r].name; r++)
                        ;
                    r === p && (n.push(h[q]),
                    o = !0)
                }
        ...
        d.$$ngfPrevFiles = h,
        j ? k() : e.validate(h, c, d, f, e.attrGetter("ngfValidateLater", d), function() {
            l(h, function() {
                b(function() {
                    k()
                }
...
ngFileUpload.directive("ngfSelect", ["$parse", "$timeout", "$compile", "Upload", function(a, b, c, d) {
    ...
    function f(a, b, c, d, f, h, i, j) {
        ...
        function o() {
            ...
            return n(a),
            a.css("visibility", "hidden").css("position", "absolute").css("overflow", "hidden").css("width", "0px").css("height", "0px").css("border", "none").css("margin", "0px").css("padding", "0px").attr("tabindex", "-1"),
            g.push({
                el: b,
                ref: a
            }),
        ...
        function p(c) {
            if (b.attr("disabled") || t("ngfSelectDisabled", a))
                return !1;
            var d = q(c);
            return null  != d ? d : (r(c),
            e(navigator.userAgent) ? setTimeout(function() {
                w[0].click()
            }
            , 0) : w[0].click(),
            !1)
...
function() {
    ...
    ngFileUpload.service("UploadDataUrl", ["UploadBase", "$timeout", "$q", function(a, b, c) {
        ...
        return d.dataUrl = function(a, d) {
            ...
            return b(function() {
                if (window.FileReader && a && (!window.FileAPI || -1 === navigator.userAgent.indexOf("MSIE 8") || a.size < 2e4) && (!window.FileAPI || -1 === navigator.userAgent.indexOf("MSIE 9") || a.size < 4e6)) {
                    ...
                    if (c && c.createObjectURL && !d) {
                        ...
                        h.onload = function(c) {
                            b(function() {
                                a.dataUrl = c.target.result,
                                g.resolve(c.target.result)
                            }
                            )
                        }
                        ,
            ...
            f = d ? a.$ngfDataUrlPromise = g.promise : a.$ngfBlobUrlPromise = g.promise,
            f["finally"](function() {
    ...
    document.getElementsByTagName("head")[0].appendChild(b[0]),
    ngFileUpload.directive("ngfSrc", ["$compile", "$timeout", "Upload", function(b, c, d) {
        return {
            restrict: "AE",
            link: function(b, e, f) {
                c(function() {
                    var g = b.$watch(f.ngfSrc, function(g) {
                        if (angular.isString(g))
                            return e.removeClass("ngf-hide"),
                            e.attr("src", g);
                        if (g && g.type && 0 === g.type.indexOf(a(e[0]))) {
                            var h = d.attrGetter("ngfNoObjectUrl", f, b);
                            d.dataUrl(g, h)["finally"](function() {
                                c(function() {
                                    g.blobUrl || g.dataUrl ? (e.removeClass("ngf-hide"),
                                    e.attr("src", (h ? g.dataUrl : g.blobUrl) || g.dataUrl)) : e.addClass("ngf-hide")
                                }
                                )
                            }
                            )
                ...
                c(function() {
                    var f = b.$watch(e.ngfBackground, function(f) {
                        if (angular.isString(f))
                            return d.css("background-image", "url('" + f + "')");
    ...
    ngFileUpload.config(["$compileProvider", function(a) {
        a.imgSrcSanitizationWhitelist && a.imgSrcSanitizationWhitelist(/^\s*(https?|ftp|local|file|data|blob):/),
        a.aHrefSanitizationWhitelist && a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|local|file|data|blob):/)
    }
    ]),
    ngFileUpload.filter("ngfDataUrl", ["UploadDataUrl", "$sce", function(a, b) {
        return function(c, d) {
            return angular.isString(c) ? b.trustAsResourceUrl(c) : c && !c.dataUrl ? (void 0 === c.dataUrl && angular.isObject(c) && (c.dataUrl = null ,
            a.dataUrl(c, d)),
            "") : (c && c.dataUrl ? b.trustAsResourceUrl(c.dataUrl) : c) || ""
        }
    }
    ])
}
...
ngFileUpload.service("UploadValidate", ["UploadDataUrl", "$q", "$timeout", function(a, b, c) {
    ...
    function e(a) {
        if (angular.isString(a)) {
            if (a.search(/kb/i) === a.length - 2)
                return parseFloat(1e3 * a.substring(0, a.length - 2));
            if (a.search(/mb/i) === a.length - 2)
                return parseFloat(1e6 * a.substring(0, a.length - 2));
            if (a.search(/gb/i) === a.length - 2)
                return parseFloat(1e9 * a.substring(0, a.length - 2));
    ...
    return f.registerValidators = function(a, b, c, d) {
        ...
        a.$formatters.push(function(g) {
            ...
            g && 0 === g.length && (g = null ),
            !b || null  != g && 0 !== g.length || b.val() && b.val(null )) : (e(a),
            a.$$ngfValidated = !1),
            g
        }
        ))
    ...
    f.validatePattern = function(a, b) {
        if (!b)
            return !0;
        var c = new RegExp(d(b),"gi");
        return null  != a.type && c.test(a.type.toLowerCase()) || null  != a.name && c.test(a.name.toLowerCase())
    }
    ,
    f.validate = function(a, b, c, d, g, h) {
        function i(c, d, e) {
            if (a) {
                for (var f = "ngf" + c[0].toUpperCase() + c.substr(1), g = a.length, h = null ; g--; ) {
                    var i = a[g]
                      , j = k(f, {
                        $file: i
                    });
                    null  == j && (j = d(k("ngfValidate") || {}),
                    h = null  == h ? !0 : h),
                    null  != j && (e(i, j) || (i.$error = c,
                    i.$errorParam = j,
                    a.splice(g, 1),
                    h = !1))
                }
                null  !== h && b.$ngfValidations.push({
                    name: c,
                    valid: h
                })
            }
        ...
        function j(c, d, e, f, g) {
            if (a) {
                var i = 0
                  , j = !1
                  , m = "ngf" + c[0].toUpperCase() + c.substr(1);
                a = void 0 === a.length ? [a] : a,
                angular.forEach(a, function(a) {
                    if (0 !== a.type.search(e))
                        return !0;
                    var n = k(m, {
                        $file: a
                    }) || d(k("ngfValidate", {
                    ...
                    , function() {
                        ...
                        l--,
                        i--,
                        i || b.$ngfValidations.push({
                            name: c,
                            valid: !j
                        }),
                        l || h.call(b, b.$ngfValidations)
                    }
                    ))
                }
                )
        ...
        b = b || {},
        b.$ngfValidations = b.$ngfValidations || [],
        angular.forEach(b.$ngfValidations, function(a) {
            a.valid = !0
        }
        );
        var k = function(a, b) {
            return f.attrGetter(a, c, d, b)
        }
        ;
        if (g)
            return void h.call(b);
        if (b.$$ngfValidated = !0,
        null  == a || 0 === a.length)
            return void h.call(b);
        if (a = void 0 === a.length ? [a] : a.slice(0),
        i("pattern", function(a) {
            return a.pattern
        }
        , f.validatePattern),
        i("minSize", function(a) {
        ...
        !a.length)
            return void h.call(b, b.$ngfValidations);
        var l = 0;
...
ngFileUpload.service("UploadResize", ["UploadValidate", "$q", "$timeout", function(a, b, c) {
    var d = a
      , e = function(a, b, c, d) {
      ...
      , f = function(a, c, d, f, g) {
        ...
        return j.onload = function() {
            try {
                var a = e(j.width, j.height, c, d);
                i.width = a.width,
                i.height = a.height;
                var b = i.getContext("2d");
                b.drawImage(j, 0, 0, a.width, a.height),
                h.resolve(i.toDataURL(g || "image/WebP", f || 1))
            } catch (k) {
                h.reject(k)
            }
        }
      ...
      , g = function(a) {
        for (var b = a.split(","), c = b[0].match(/:(.*?);/)[1], d = atob(b[1]), e = d.length, f = new Uint8Array(e); e--; )
            f[e] = d.charCodeAt(e);
        return new Blob([f],{
            type: c
        })
    ...
    ;
    return d.resize = function(a, e, h, i) {
        var j = b.defer();
        return 0 !== a.type.indexOf("image") ? (c(function() {
            j.resolve("Only images are allowed for resizing!")
        }
        ),
        j.promise) : (d.dataUrl(a, !0).then(function(b) {
            f(b, e, h, i, a.type).then(function(b) {
                var c = g(b);
                c.name = a.name,
                j.resolve(c)
            }
...
function() {
    function a(a, c, d, e, f, g, h, i) {
        ...
        function k(a, b, c, d) {
            var e = n("ngfDragOverClass", a, {
                $event: c
            })
              , f = n("ngfDragOverClass") || "dragover";
            if (angular.isString(e))
                return void d(e);
            if (e && (e.delay && (r = e.delay),
            e.accept || e.reject)) {
                var g = c.dataTransfer.items;
                if (null  != g)
                    for (var h = n("ngfPattern", a, {
                        $event: c
                    }), j = 0; j < g.length; j++)
                        if ("file" === g[j].kind || "" === g[j].kind) {
        ...
        function l(a, b, c, d) {
                    ...
                    if (b.isDirectory) {
                        ...
                        var h = function() {
                            f.readEntries(function(d) {
                                try {
                                    if (d.length)
                                        g = g.concat(Array.prototype.slice.call(d || [], 0)),
                                        h();
                                    else {
            ...
            if (j && j.length > 0 && "file" !== h.protocol())
                ...
                if (null  != n)
                    for (var o = 0; o < n.length && (f.push(n.item(o)),
                    d || !(f.length > 0)); o++)
                        ;
            }
            var p = 0;
        ...
        , !1),
        c[0].addEventListener("dragleave", function() {
            j() || (p = g(function() {
                c.removeClass(o),
                o = null 
            }
        ...
        c[0].addEventListener("paste", function(b) {
            if (!j()) {
                var c = []
                  , f = b.clipboardData || b.originalEvent.clipboardData;
                if (f && f.items) {
...
/*
 * angular-services 分页服务 可爱美丽大方善良聪明活泼有才乖巧的小智
 * 
 * Version: 1.0.0 - 2015-09-03 License: IND
 */
var services = angular.module("services", []);
services.factory("Paginator", function() {
    // 虽然这是一个服务，但是用户每次调用它时都会获得一个全新的Paginator
    // 这是因为我们会返回一个function，当它被执行时会返回一个对象
    return function(fetchFunction, pageSize) {
        var paginator = {
            hasDataVar: true,
            hasData: function() {
                return this.hasDataVar;
            },
            hasNextVar: false,
            next: function() {
                if (this.hasNextVar) {
            ...
            _load: function() {
                var self = this;
                fetchFunction(self.currentOffset, pageSize + 1, function(items) {
                    self.currentPageItems = items.slice(0, pageSize);
                    if (self.currentOffset == 0 && self.currentPageItems.length === 0) {
                        // 查看第一页有没有数据
                        self.hasDataVar = false;
                    }
...
// angularJS实现的查看更多服务
services.factory("MoreContents", function() {
    return function(fetchFunction, showSize) {
        var moreContents = {
            hasMoreVar: false,
            errorWarning: "",
            more: function() {
                if (this.hasMoreVar) {
                    this.currentOffset += showSize;
                    this._load();
                }
            },
            _load: function() {
                var self = this;
                fetchFunction(this.currentOffset, showSize + 1, function(items) {
                    if (items.errorCode) {
                        self.errorWarning = items.errorCode;
                        return;
                    }
                    self.currentShowItems = self.currentShowItems.concat(items.slice(0, showSize));
                    self.hasMoreVar = items.length === showSize + 1;
                }
                );
            },
            hasMore: function() {
                return this.hasMoreVar;
            },
            currentShowItems: [],
            currentOffset: 0,
        };
