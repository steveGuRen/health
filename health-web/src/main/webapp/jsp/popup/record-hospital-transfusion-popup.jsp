		...
		<div class="modal-content">
			...
			<div class="modal-body"
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label">输血量(ml):</label>
					<div class="col-xs-8">
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label" style = "margin-top: 16px" >输血时间:</label>
					<div class = "col-xs-8">
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label" style = "margin-top: 16px" >原因:</label>
					<div class = "col-xs-8">
						<div style="float: left; display: block;width:100%;margin-top: 16px" >
							<div style = "width: 100%;">
