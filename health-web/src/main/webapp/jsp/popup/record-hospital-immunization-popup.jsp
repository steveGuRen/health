		...
		<div class="modal-content">
			...
			<div class="modal-body"
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label">非免疫规划预防接种名称:</label>
					<div class="col-xs-8">
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label" style = "margin-top: 16px" >非免疫规划预防接种时间:</label>
					<div class = "col-xs-8">
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label">非免疫规划预防接种机构:</label>
					<div class="col-xs-8">
						<div style="float: left; display: block;width:100%">
							<div style = "width: 100%">
