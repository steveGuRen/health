		...
		<div class="modal-content">
			...
			<div class="modal-body"
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label" style = "float: left;">输血量(ml)</label>
					<div class="col-xs-8">
						<div style="float: left; display: block;width:100%">
							<div style = "width: 100%">
								<input ng-model="object.bloodTransfusion" type="text" class="form-control" placeholder="请输入输血量">
							</div>
						</div>
					</div>
				</div>
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label" style = "margin-top: 16px;float: left;" >输血时间:</label>
					<div class = "col-xs-8">
						<div style="float: left; display: block;width:100%;margin-top: 16px" >
							<div style = "width: 100%">
								<input type="text" ng-model="object.transfusionTime" class="form-control" id="one-datePay"
				...
				<div class="form-group" style = "width:100%">
					<label class="fn-title control-label" style = "margin-top: 16px;float: left;" >输血原因:</label>
					<div class = "col-xs-8">
						<div style="float: left; display: block;width:100%;margin-top: 16px" >
							<div style = "width: 100%;">
								<textarea ng-model="object.cause" type="text" rows = "6" placeholder="请输入描述" style = "width: 100%"></textarea>
							</div>
						</div>
					</div>
				</div>
