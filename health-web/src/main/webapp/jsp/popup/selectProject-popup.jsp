...
<div class="bootstrap-wysihtml5-insert-link-modal modal fade in"
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<div class="modal-body" style="display: inline-block; overflow-y: scroll; height: 350px;width: 100%;">
				<div class="form-group" style="width: 100%; padding-left: 40px;">
					<div style="display: block; float: left; width: 50%;"
						ng-repeat="item in projects">
						<div ng-if="!selectPremises.idList || selectPremises.idList.indexOf(item.organizationId)==-1" >
							...
							<div
								style="float: left; font-size: 14px; padding: 0px 20px; font-weight: bold;">{{item.organizationName}}</div>
						</div>
						<div ng-if="selectPremises.idList && selectPremises.idList.indexOf(item.organizationId)!=-1">
							<div style="display: block; float: left;">
								<input ng-click="checkClick($index)"
