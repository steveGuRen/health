...
<div class="row" style="margin-left: 55%; width: 45%;">
	...
	<button ng-show="!pageContent" class="btn btn-info pull-right" style="margin: 10px;" ng-click="queryList(1);">关联</button>
	</div>
</div>
<!-- 导航栏 -->
		...
		<form class="form-horizontal">
			<div class="box-body" style="width: 100%; display: block;">
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						<input ng-model="queryParam.billingAreaStart" type="text" class="form-control" placeholder="请输入设备名称">
					</div>
					
				</div>
				<div class="form-group">
					<label class="fn-title control-label">设备状态</label>
			...
			<table id="example2"
				...
				<thead>
					<tr role="row">
						...
						<th class="sorting">最近连接时间</th>
						<th class="sorting">最近传输数据时间</th>
						<th class="sorting">蓝牙</th>
						<th class="sorting">数据线</th>
