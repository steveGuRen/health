		...
		<form class="form-horizontal">
			<div class="box-body" style="width: 100%; display: block;">
				...
				<div class="form-group">
					<label class="fn-title control-label">病历名称</label>

					<div class="col-xs-5">
						<input ng-model="queryParam.billingAreaStart" type="text" class="form-control" placeholder="请输入病历名称">
					</div>
					
				</div>
				<div class="form-group">
					<label class="fn-title control-label">病历状态</label>

					<div class="col-xs-5">
						<select ng-model="queryParam.houseType">
						 	<option value="">---请选择病历状态---</option>
	      					<option value="0">治疗前</option>
	      					<option value="1">治疗中</option>
							<option value="2">治疗后</option>
	    				</select>
					</div>
				</div>
	...
	<div class="row">
		<div class="col-sm-12">
			<table id="example2"
				...
				<thead>
					<tr role="row">
						<th class="sorting">病历名称</th>
						<th class="sorting">病历ID</th>
						<th class="sorting">病历状态</th>
						<th class="sorting">病历创建时间</th>
						<th class="sorting">病历类型</th>
						<th class="sorting">病历用途</th>
					</tr>
				</thead>
				<tbody>
